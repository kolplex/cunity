...
<div class="row">
    <div class="col-lg-8">        
        <div class="panel panel-default">
            ...
            <div class="panel-body"><div id="userstatistics" class="graphbox loaderbox"></div></div>
        </div> 
        <div class="panel panel-default">
            <div class="panel-heading">
        ...
        <div class="panel panel-default">
            ...
            <table class="table">
                ...
                <tr>
                    ...
                    <td>
                        <span class="label label-info">{-"language"|setting}</span>
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <span class="label label-info">{-"design"|setting}</span>
                    </td>
                </tr>              
            </table>
        </div>               
