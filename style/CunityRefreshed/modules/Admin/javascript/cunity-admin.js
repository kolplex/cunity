...
function loadPage(cat, page) {
    $('#page-wrapper').load(convertUrl({module: "admin", action: cat, x: page}));
    window.setTimeout(function() {
        loadExternalFile(siteurl + "style/" + design + "/modules/Admin/" + cat + "/css/" + page + ".css", "css");
        loadExternalFile(siteurl + "style/" + design + "/modules/Admin/" + cat + "/javascript/" + page + ".js", "js");
    }, 500);
}
