    ...
    <div class="col-lg-12">        
        <div class="panel panel-default" id="editPagePanel">
            ...
            <div class="panel-body">
                <form class="ajaxform" action="{-"index.php?m=admin&action=settings"|URL}" id="pageform" method="POST">
                    <div class="form-group">
                        ...
                        <input type="text" name="title" class="form-control" id="pages-title" placeholder="{-"Choose a short Title for this page"|translate}">
                    </div>
                    <div class="form-group">
            ...
            <div class="panel-footer clearfix">
                <button class="btn btn-primary pull-right addpagebutton" onclick="$('#pageform').submit();"><i class="fa fa-plus"></i>&nbsp;{-"Create page"|translate}</button>
                <button class="btn btn-primary pull-right editpagebutton hidden" onclick="$('#pageform').submit();"><i class="fa fa-refresh"></i>&nbsp;{-"Update page"|translate}</button>
                <button class="btn btn-default pull-right editpagecancel hidden" style="margin-right:10px;"><i class="fa fa-times"></i>&nbsp;{-"Cancel"|translate}</button>
            </div>
        </div>         
    </div>
</div>  
<script id="pages-row" type="text/html">
    <tr id="page-row-{%=o.id%}" class="page-table-row">
        <td>
            <strong><a href="{-"siteurl"|setting}pages/{%=o.shortlink%}" class="table-row-title" target="_blank">{%#o.title%}</a></strong>
            <div class="pagescontent">{%#o.content%}</div><a class="btn-sm btn btn-default slideup hidden"><i class="fa fa-chevron-up"></i>&nbsp;{-"Close"|translate}</a></td>
