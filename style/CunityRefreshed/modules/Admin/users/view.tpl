<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">{-"Userlist"|translate}<button class="btn btn-primary pull-right" data-toggle="modal" data-target="#addusermodal"><i class="fa fa-plus"></i>&nbsp;{-"Add User"|translate}</button></h1>
        <ol class="breadcrumb">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group btn-group-sm">
                                    <button type="button" class="btn btn-primary" {-if $user.userid eq $userItem.userid} disabled{-/if}>{-"Actions"|translate}</button>
                                    <button type="button" class="btn btn-primary dropdown-toggle" {-if $user.userid eq $userItem.userid} disabled{-/if} data-toggle="dropdown">
                                        <span class="caret"></span>                   
                                    </button>
                                    <ul class="dropdown-menu" role="menu">
                                        <li><a href="#"><i class="fa fa-trash-o"></i>&nbsp;{-"Delete this user"|translate}</a></li>
                                            {-if $user.groupid eq 0}
                                            <li><a href="#"><i class="fa fa-check"></i>&nbsp;{-"Activate this user"|translate}</a></li>
                                            {-/if}
                                            {-if $userItem.groupid < 3}
                                            <li class="divider"></li>
                                                {-if $userItem.groupid != 2}
                                                <li><a href="#"><i class="fa fa-wrench"></i>&nbsp;{-"Make Administrator"|translate}</a></li>
                                                {-else if $userItem.groupid eq 2}
                                                <li><a href="#"><i class="fa fa-ban"></i>&nbsp;{-"Remove Administrator"|translate}</a></li>
                                                {-/if}
                                            {-/if}
                                    </ul>
                                </div>
            ...
            <ul class="list-group">
                <li class="list-group-item">
                    <label class="checkbox">
                        <input type="checkbox">&nbsp;{-"Active Users"|translate}
                    </label>
                </li>
                <li class="list-group-item">
                    <label class="checkbox">
                        <input type="checkbox">&nbsp;{-"Not verified Users"|translate}
                    </label>
                </li>
                <li class="list-group-item">
                    <label class="checkbox">
                        <input type="checkbox">&nbsp;{-"Administrators"|translate}
                    </label>
                </li>
            </ul>
        </div>
