...
<form class="form-horizontal" action="{-"index.php?m=contact&action=sendContact"|URL}" method="post">
    <div class="form-group">
        <label class="control-label col-lg-3">{-"Firstname"|translate}</label>
        <div class="col-lg-6">
            <input type="text" name="firstname" value="{-$userData.firstname}" class="form-control" {-if !$userData.firstname eq ""} readonly{-/if}>
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-lg-3">{-"Lastname"|translate}</label>
        <div class="col-lg-6">
            <input type="text" name="lastname" value="{-$userData.lastname}" class="form-control" {-if !$userData.lastname eq ""} readonly{-/if}>
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-lg-3">{-"E-Mail"|translate}</label>
        <div class="col-lg-8">
            <input type="email" name="email" value="{-$userData.email}" class="form-control" {-if !$userData.email eq ""} readonly{-/if}>
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-lg-3">
            <input type="submit" value="{-"Send"|translate}" class="btn btn-primary pull-right form-control">
        </div>
    </div>
</form>