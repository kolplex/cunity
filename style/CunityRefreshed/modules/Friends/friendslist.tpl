<div class="page-buttonbar clearfix">
    ...
    <button class="btn btn-primary tooltip-trigger pull-right notification-link-friends" title="{-"Friend Requests"|translate}" onclick="getNotification('friends');"><i class="fa fa-question"></i></button>
