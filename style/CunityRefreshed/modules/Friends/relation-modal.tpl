    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer addasfriend hidden modal-category">
                ...
                <button type="button" class="btn btn-primary" onclick="addFriend();">{-"Add as friend"|translate}</button>
            </div>
            <div class="modal-footer relationship hidden modal-category">
                <a href="javascript:void(0);" onclick="changeRelationship(2);" class="text-danger pull-left">{-"End Relationship"|translate}</a>
                <button type="button" class="btn btn-default" data-dismiss="modal">{-"Cancel"|translate}</button>
                <button type="button" class="btn btn-primary" onclick="changeRelationship($('#relationshipSelect').val());">{-"Save"|translate}</button>
            </div>
            <div class="modal-footer removerequest hidden modal-category">
                <button type="button" class="btn btn-default" data-dismiss="modal">{-"Cancel"|translate}</button>
                <button type="button" class="btn btn-primary" onclick="removeFriend();">{-"Remove it!"|translate}</button>
            </div>
            <div class="modal-footer removefriend hidden modal-category">
                <button type="button" class="btn btn-default" data-dismiss="modal">{-"Cancel"|translate}</button>
                <button type="button" class="btn btn-primary" onclick="removeFriend();">{-"I'm Sure!"|translate}</button>
            </div>
            <div class="modal-footer confirmfriend hidden modal-category">
                <a href="javascript:void(0);" onclick="removeFriend();" class="text-danger pull-left">{-"Delete Request"|translate}</a>
                <button type="button" class="btn btn-default" data-dismiss="modal">{-"Cancel"|translate}</button>
            ...
            <div class="modal-footer blockperson hidden modal-category">
                <button type="button" class="btn btn-default" data-dismiss="modal">{-"Cancel"|translate}</button>
                <button type="button" class="btn btn-primary" onclick="blockFriend();">{-"Sure, do it!"|translate}</button>
            </div>
            <div class="modal-footer unblock hidden modal-category">
                <button type="button" class="btn btn-default" data-dismiss="modal">{-"Cancel"|translate}</button>
                <button type="button" class="btn btn-primary" onclick="removeFriend();">{-"Sure, do it!"|translate}</button>
            </div>
        </div>
    </div>
</div>            