            ...
            <div class="modal-content">
                <div class="modal-body" style="padding: 0 !important">
                    <div class="modal-body-content">
                        ...
                        <div class="modal-body-info hidden">
                            ...
                            <div class="socialbox likebox">
                                <button type="button" class="btn btn-success imagelike"><i class="fa fa-smile-o"></i>&nbsp;{-"Like"|translate}</button>
                                <button type="button" class="btn btn-danger imagedislike"><i class="fa fa-frown-o"></i>&nbsp;{-"Dislike"|translate}</button>
                                <button type="button" class="btn btn-default imageunlike tooltip-trigger hidden" data-title="{-"Remove all your Like/Dislike from this image"|translate}"><i class="fa fa-meh-o"></i></button>
                    ...
                    <div class="info-overlay clearfix">
                        <p class="pull-left">{-"Image"|translate} <span class="image-index"></span> {-"of"|translate} <span class="image-full-count">{-$album.photo_count}</span> {-"from the Album"|translate}: {-$album.title}</p>
                        {-*<div class="dropdown dropup pull-right">
                            <p class="pull-right" role="button" data-toggle="dropdown" data-target="#"><i class="fa fa-cogs"></i>&nbsp;{-"Options"|translate}</p>
