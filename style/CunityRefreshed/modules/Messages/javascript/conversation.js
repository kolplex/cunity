...
$(document).ready(function() {
    ...
    $(document).on("mouseenter", "#conversation-content .conversation-item-me .conversation-item-content-wrap", function() {
        ...
        if ($(this).html() !== "")
            $(".conversation-writingbox input[type='submit']").removeProp('disabled');
        else
            $(".conversation-writingbox input[type='submit']").prop('disabled');
...
function loadMoreMessages(refresh) {
    ...
    if (refresh) {
        ...
        refreshId = 0;
    sendRequest({conversation_id: $("#conversation_id").val(), offset: countOffset, refresh: refreshId}, "messages", "loadConversationMessages", function(res) {
...
function leaveConversation(delMsgs) {
    sendRequest({conversation_id: $("#conversation_id").val(), delMsgs: delMsgs}, "messages", "leaveConversation", function(res) {
