<div class="page-buttonbar clearfix">
    ...
    <div class="btn-group pull-right">        
        <button type="button" class="btn btn-default dropdown-toggle tooltip-trigger" id="filter-dropdown" data-toggle="dropdown" data-title="{-"Filter the posts you want to see"|translate}"><i class="fa fa-filter"></i></button>        
    ...
    <button class="btn btn-default pull-right tooltip-trigger" data-title="{-"Check for new posts manually"|translate}" onclick="load(true);" id="newsfeed-refresh"><i class="fa fa-refresh"></i></button>
</div>
<form class="newsfeed-newpost ajaxform clearfix" action="{-"index.php?m=newsfeed&action=send"|URL}" method="post">
    ...
    <div class="pull-right clearfix newsfeed-post-area">
        ...
        <div class="pull-left newsfeed-post-file-input">
            ...
            <button class="btn btn-primary hidden" id="newsfeed-upload" type="button"><i class="fa fa-search"></i>&nbsp;{-"Select Photo"|translate}</button>
    ...
    <div class="btn-group pull-right hidden newsfeed-post-buttons">                
        <button class="btn btn-primary tooltip-trigger" data-title="{-"Select who will be allowed to see this post"|translate}" data-toggle="dropdown"><span class="fa fa-lock"></span>&nbsp;<i class="caret"></i></button>                
        ...
        <ul class="dropdown-menu" role="menu" aria-labelledby="privacy-dropdown">            
            <li role="presentation"><a role="menuitem" tabindex="-1" href="javascript:selectPostPrivacy(0);"><i class="fa fa-globe fa-fw"></i>&nbsp;{-"Public"|translate}</a></li>
            <li role="presentation"><a role="menuitem" tabindex="-1" href="javascript:selectPostPrivacy(1);"><i class="fa fa-users fa-fw"></i>&nbsp;{-"Friends"|translate}</a></li>
            <li role="presentation" class="divider"></li>
            <li role="presentation"><a role="menuitem" tabindex="-1" href="javascript:selectPostPrivacy(2);"><i class="fa fa-user fa-fw"></i>&nbsp;{-"Only Me"|translate}</a></li>
        </ul>
    </div>   
</form>
<div class="newsfeed-postbox">
    ...
    <button class="btn btn-block btn-primary newsfeed-postbox-load-more hidden" onclick="load();"><i class="fa fa-clock-o"></i>&nbsp;{-"Load more Posts"|translate}</button>
</div>
