...
<div style="padding:10px;margin-top: 200px;">
    <div id="editProfileImages">
        ...
        {-if $type eq "profile"}
            ...
            {-/if}
        <form action="{-"index.php?m=profile&action=edit"|URL}" method="post" class="form-horizontal" enctype="multipart/form-data">
            <input type="hidden" name="type" value="{-$type}">
            <input type="hidden" name="imageid" value="{-$result.id}">
            <input type="hidden" name="crop-image" value="../data/uploads/{-"filesdir"|setting}/{-$result.filename}">
