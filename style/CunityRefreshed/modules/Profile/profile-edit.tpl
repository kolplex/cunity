...
<div class="profile-banner {-if $profile.timg eq null}profile-banner-empty{-/if}" style="background-image: url('{-"siteurl"|setting}data/uploads/{-"filesdir"|setting}/cr_{-$profile.timg}');">
...
<ul class="nav nav-pills profile-menu" id="profile-menu">
    <li><a href="{-"index.php?m=profile"|URL}" class="tab-no-follow"><i class="fa fa-chevron-left"></i>&nbsp;{-"Back"|translate}</a></li>
    <li class="active"><a href="#editAccount" data-toggle="pill"><i class="fa fa-cogs"></i>&nbsp;{-"My Account"|translate}</a></li>
    <li class=""><a href="#editPrivacy" data-toggle="pill"><i class="fa fa-lock"></i>&nbsp;{-"Privacy"|translate}</a></li>
    <li class=""><a href="#editProfileImages" data-toggle="pill" data-type="profile"><i class="fa fa-picture-o"></i>&nbsp;{-"Images"|translate}</a></li>
    <li class=""><a href="#editProfilePins" data-toggle="pill"><i class="fa fa-thumb-tack"></i>&nbsp;{-"Profile Pins"|translate}</a></li>
    <li class=""><a href="#editNotifications" data-toggle="pill"><i class="fa fa-envelope-o"></i>&nbsp;{-"Notifications"|translate}</a></li>
</ul>
<div class="tab-content" style="border-top:1px solid #ccc;padding-top:10px">
        ...
        <div class="col-md-9 tab-content section-content">
                    ...
                    <form action="{-"index.php?m=profile&action=edit"|URL}" method="post" class="form-horizontal ajaxform">
                        ...
                        <div class="form-group">
                            <div class="col-md-offset-3 col-md-9 clearfix">
                                ...
                                <button type="submit" class="btn btn-primary pull-right"><i class="fa fa-save"></i> {-"Save"|translate}</button>                                
                            </div>
                        </div>
                    </form>
                </div>
            ...
            <div class="tab-pane panel panel-default" id="editAccountDelAcc">
                ...
                <div class="panel-body clearfix">
                    ...
                    <a href="{-"index.php?m=register&action=delete"|URL}" class="btn btn-primary pull-right" style="margin-top:20px">{-"Yes, I am sure. Delete my account"|translate}</a>
                </div>
            </div>
        </div>
    </div>
    <div class="tab-pane clearfix" id="editPrivacy">
        ...
        <div class="col-md-9 tab-content section-content">
            <div class="tab-pane panel panel-default active" id="editPrivacyGeneral">
                ...
                <div class="panel-body">                    
                    <form action="{-"index.php?m=profile&action=edit"|URL}" method="post" class="form-horizontal ajaxform" id="privacyForm">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <select class="form-control" name="privacy[search]" id="privacyselect-search">
                                    <option value="0" {-if $profile.privacy.search == 0}selected{-/if}>{-"No one"|translate}</option>
                                    <option value="1" {-if $profile.privacy.search == 1}selected{-/if}>{-"Friends"|translate}</option>
                                    {-*<option value="2" {-if $profile.privacy.search == 2}selected{-/if}>{-"Friends of Friends"|translate}</option>*}
                                    <option value="3" {-if $profile.privacy.search == 3}selected{-/if}>{-"Everyboy"|translate}</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <select class="form-control" name="privacy[visit]" id="privacyselect-visit">
                                    <option value="0" {-if $profile.privacy.visit == 0}selected{-/if}>{-"No one"|translate}</option>
                                    <option value="1" {-if $profile.privacy.visit == 1}selected{-/if}>{-"Friends"|translate}</option>
                                    {-*                                <option value="2" {-if $profile.privacy.visit == 2}selected{-/if}>{-"Friends of Friends"|translate}</option>*}
                                    <option value="3" {-if $profile.privacy.visit == 3}selected{-/if}>{-"Everyboy"|translate}</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <select class="form-control" name="privacy[message]" id="privacyselect-message">
                                    <option value="0" {-if $profile.privacy.message == 0}selected{-/if}>{-"No one"|translate}</option>
                                    <option value="1" {-if $profile.privacy.message == 1}selected{-/if}>{-"Friends"|translate}</option>
                                    {-*<option value="2" {-if $profile.privacy.message == 2}selected{-/if}>{-"Friends of Friends"|translate}</option>*}
                                    <option value="3" {-if $profile.privacy.message == 3}selected{-/if}>{-"Everyboy"|translate}</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <select class="form-control" name="privacy[posts]" id="privacyselect-posts">
                                    <option value="0" {-if $profile.privacy.posts == 0}selected{-/if}>{-"No one"|translate}</option>
                                    <option value="1" {-if $profile.privacy.posts == 1}selected{-/if}>{-"Friends"|translate}</option>
                                    {-*<option value="2" {-if $profile.privacy.posts == 2}selected{-/if}>{-"Friends of Friends"|translate}</option>*}
                                    <option value="3" {-if $profile.privacy.posts == 3}selected{-/if}>{-"Everyboy"|translate}</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
    ...
    <div id="editProfileImages" class="tab-pane clearfix">
        <div class="col-md-3">
            <div class="list-group">                
                <a href="#editProfileImage" class="list-group-item active" data-toggle="tab" data-type="profile">{-"Profile Image"|translate}</a>
                <a href="#editTitleImage" class="list-group-item" data-toggle="tab" data-type="title">{-"Title Image"|translate}</a>
            </div>
        </div>
        <div class="col-md-9 tab-content section-content">            
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    <span class="input-group-btn">
                                        <button class="btn btn-primary" id="profile-upload" type="button"><i class="fa fa-search"></i>&nbsp;{-"Select Photo"|translate}</button>
                                    </span>
                        ...
                        <div class="form-group clearfix">
                            <div class="col-md-9">
                                <button type="button" class="btn btn-link text-danger image-delete" data-type="profile"><i class="fa fa-trash-o"></i>&nbsp;{-"Delete current Profile-Image"|translate}</button>
                            </div>
                            <div class="col-md-3">
                                <button type="button" class="btn btn-primary pull-right" onclick="uploadPhoto();" data-loading-text="{-"Uploading"|translate}..."><i class="fa fa-upload"></i> {-"Upload"|translate}</button>
                            </div>
                        </div>
                    </form>
                </div>
                    ...
                    <form class="form-horizontal" role="form">                                                
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    <span class="input-group-btn">
                                        <button class="btn btn-primary" id="title-upload" type="button"><i class="fa fa-search"></i>&nbsp;{-"Select Photo"|translate}</button>
                                    </span>
                        ...
                        <div class="form-group">
                            <div class="col-md-9">
                                <button type="button" class="btn btn-link text-danger image-delete" data-type="title"><i class="fa fa-trash-o"></i>&nbsp;{-"Delete current Title-Image"|translate}</button>
                            </div>
    ...
    <div class="profile-pins tab-pane" id="editProfilePins">    
        <div class="clearfix">
            <span class="pull-left text-info" style="padding: 7px 0">{-"Grab the pins to move them!"|translate}</span><a class="btn btn-primary pull-right" data-action="add" data-toggle="modal" href="#newpinmodal"><i class="fa fa-plus"></i> {-"Add a new Pin"|translate}</a>
        </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="form-horizontal ajaxform" role="form" id="newPinForm" method="post" action="{-"index.php?m=profile&action=edit"|URL}">
                            <input type="hidden" name="edit" value="pin">
                            <div class="form-group">
                                <label class="col-lg-2 control-label">{-"Title"|translate}</label>
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" maxlength="53" name="title" placeholder="{-"Give the pin a title!"|translate}">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group hidden" id="pin-type-2">
                                ...
                                <div class="col-lg-10">
                                    ...
                                    <div id="profile-pin-summernote"></div>
                                </div>
                            </div>
                    ...
                    <div class="modal-footer">
                        <a href="#" class="text-danger pull-left deletepin hidden" style="margin-top:7px" data-confirmation="{-"Are You sure You want to delete this profile-pin?"|translate}">{-"Delete this Profile-Pin"|translate}</a>
                        <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                        <button type="button" class="btn btn-primary newpinbutton" onclick="$('#newPinForm').submit();">{-"Create"|translate}</button>
                        <button type="button" class="btn btn-primary editpinbutton" onclick="$('#newPinForm').submit();">{-"Update"|translate}</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div id="editNotifications" class="tab-pane">
        <div class="col-md-3">
            <div class="list-group">
                <a href="#editNotificationsGeneral" class="list-group-item active" data-toggle="tab">{-"General"|translate}</a>
            </div>
        </div>
        <div class="col-md-9 tab-content section-content">
            <form class="tab-pane panel panel-default active ajaxform" action="{-"index.php?m=profile&action=edit"|URL}" id="editProfileImage" method="post">
                ...
                <table class="table table-striped">
                    <thead>
                        <tr>
                            ...
                            <th width="10%">
                                <i class="fa fa-bell tooltip-trigger" data-title="{-"Display a notification on this Website"|translate}"></i>
                            </th>
                            <th width="10%">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><input type="checkbox" name="alert[wall_post]" value="1"></td>
                            <td><input type="checkbox" name="mail[wall_post]" value="1"></td>
                        </tr>
                        <tr>
                            <td>{-"Someone sent you a message"|translate}<input type="hidden" name="types[message]" value="1"></td>
                            <td><input type="checkbox" name="alert[message]" value="1"></td>
                            <td><input type="checkbox" name="mail[message]" value="1"></td>
                        </tr>
                        <tr>
                            <td>{-"Someone add you to a conversation"|translate}<input type="hidden" name="types[addconversation]" value="1"></td>
                            <td><input type="checkbox" name="alert[addconversation]" value="1"></td>
                            <td><input type="checkbox" name="mail[addconversation]" value="1"></td>
                        </tr>
                        <tr>
                            <td>{-"Someone add you as a friend"|translate}<input type="hidden" name="types[addfriend]" value="1"></td>
                            <td><input type="checkbox" name="alert[addfriend]" value="1"></td>
                            <td><input type="checkbox" name="mail[addfriend]" value="1"></td>
                        </tr>
                        <tr>
                            <td>{-"Someone confirms your friend-request"|translate}<input type="hidden" name="types[confirmfriend]" value="1"></td>
                            <td><input type="checkbox" name="alert[confirmfriend]" value="1"></td>
                            <td><input type="checkbox" name="mail[confirmfriend]" value="1"></td>
                        </tr>
                        {-*<tr>
...
<script type="text/html" id="profilepin">
    <div class="panel panel-default" id="pin-{%=o.id%}" data-pinid="{%=o.id%}">
        <div class="panel-heading"><i class="fa fa-fw fa-{%=o.iconclass%}"></i>{%=o.title%}<a href="#" data-target="#newpinmodal" data-pinid="{%=o.id%}" data-action="edit" data-toggle="modal" class="pull-right tooltip-trigger" data-title="{-"edit Pin"|translate}"><i class="fa fa-fw fa-cog"></i></a></div>                                    
        {% if (o.type == 2) { %}
        <div class="panel-body">
            {%#o.content%}
        </div>
