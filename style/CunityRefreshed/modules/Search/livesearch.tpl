...
<script type="text/html" id="livesearch-result">
    ...
    <article class="searchresult-item clearfix" id="livesearchresult-item-{%=o.userid%}">
        ...
        <div class="pull-right nofriends-buttons btn-group btn-group-sm friend-buttons{% if (o.status !== null){ %} hidden{% } %}">                   
            <button class="btn btn-default" data-userid="{%=o.userid%}" data-parent="#livesearchresult-item-{%=o.userid%}" data-action="addasfriend" data-toggle="modal" data-target="#relationship-modal"><span class="fa fa-plus"></span> {-"Add as friend"|translate}</button>
        ...
        <div class="pull-right blocked-buttons btn-group btn-group-sm friend-buttons{% if (o.status != 0 || o.sender != $user.userid){ %} hidden{% } %}">                   
            ...
            <button class="btn btn-default dropdown-toggle" data-toggle="dropdown"><span class="caret"></span></button>
            <ul class="dropdown-menu">                                                
                <li><a href="#" data-target="#relationship-modal" data-parent="#livesearchresult-item-{%=o.userid%}" data-toggle="modal" data-action="unblock" data-userid="{%=o.userid%}"><i class="fa fa-eraser"></i> {-"Unblock"|translate}</a></li>
            </ul>                                               
        </div>
        <div class="pull-right request-buttons btn-group btn-group-sm friend-buttons{% if (o.status != 1 || o.sender != o.userid){ %} hidden{% } %}">                   
            <button class="btn btn-default" data-userid="{%=o.userid%}" data-parent="#livesearchresult-item-{%=o.userid%}" data-action="confirmfriend" data-toggle="modal" data-target="#relationship-modal"><span class="fa fa-question"></span> {-"Answer Request"|translate}</button>
            <button class="btn btn-default dropdown-toggle" data-parent="#livesearchresult-item-{%=o.userid%}" data-toggle="dropdown"><span class="caret"></span></button>
            <ul class="dropdown-menu">
                {% if (o.privacy.message == 3){ %}
                <li><a href="javascript:sendMessage('{%=o.name%}',{%=o.userid%});"><i class="fa fa-envelope-o"></i> {-"Send message"|translate}</a></li>
                {% } %}
        ...
        <div class="pull-right pending-buttons btn-group btn-group-sm friend-buttons{% if (o.status != 1 || o.sender == o.userid){ %} hidden{% } %}">                   
            ...
            <ul class="dropdown-menu">
                ...
                <li><a href="#" data-userid="{%=o.userid%}" data-parent="#livesearchresult-item-{%=o.userid%}" data-action="blockperson" data-toggle="modal" data-target="#relationship-modal"><i class="fa fa-ban"></i> {-"Block Person"|translate}</a></li>
                <li class="divider"></li>
                <li><a href="#" data-userid="{%=o.userid%}" data-parent="#livesearchresult-item-{%=o.userid%}" data-action="removerequest" data-toggle="modal" data-target="#relationship-modal"><i class="fa fa-times"></i> {-"Remove request"|translate}</a></li>
            </ul>                    
        </div>
