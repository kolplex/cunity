...
<html>
    <head>        
        <meta charset="utf-8">        
        <title>{-$meta.title}&nbsp;|&nbsp;{-"sitename"|setting}</title>
        ...
        <link rel="stylesheet" type="text/css" href="{-"siteurl"|setting}style/CunityRefreshed/modules/Start/css/style.css" media="screen and (min-width: 1024px)">
        <link rel="stylesheet" type="text/css" href="{-"siteurl"|setting}style/CunityRefreshed/modules/Start/css/style-mobile.css" media="screen and (max-width: 1023px)">
        <link rel="stylesheet" type="text/css" href="{-"siteurl"|setting}style/CunityRefreshed/css/bootstrap.min.css">
    ...
    <body>
        <header class="head">
            <div class="content">
                ...
                <form class="login-form form-inline pull-right" action="{-"index.php?m=register&action=login"|URL}" method="post">
                    ...
                    <div class="form-group">
                        <input type="password" name="password" placeholder="{-"Password"|translate}" class="form-control" tabindex="2">
        ...
        <div class="main-start">
            <div class="main-start-container">
                <div class="start-page-content">
                    <img src="{-"siteurl"|setting}style/CunityRefreshed/img/startpage.jpg">
                ...
                <div class="registration-start">
                    {-include file="Register/registration.tpl"}
                </div>
            </div>
        </div>
        <div class="login-buttons clearfix">
            ...
            <button class="btn btn-default pull-right btn-large info-button" data-toggle="dropdown" data-href="infomenu"><i class="fa fa-info"></i></button>
            <button class="btn btn-default pull-right btn-large" data-toggle="modal" data-target="#loginModal">{-"Login"|translate}</button>
        ...
        <footer class="footer">
            <ul class="footer-menu-start list-inline list-unstyled">
                ...
                <li>|</li>
                <li><a href="{-"index.php?m=contact"|URL}">{-"Contact"|translate}</a></li>
                <li class="pull-right copyright-start">Powered by Cunity - &copy; {-$smarty.now|date_format:"%Y"} by Smart In Media</li>
            </ul>
        </footer>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="login-form form-horizontal" action="{-"index.php?m=register&action=login"|URL}" method="post" style="margin:10px;">
                            <div class="form-group">
                                <input type="email" name="email" placeholder="E-Mail" class="form-control" tabindex="1">                                
                            </div>
                            <div class="form-group clearfix">
                                <input type="password" name="password" placeholder="{-"Password"|translate}" class="form-control" tabindex="2">
                                <label class="checkbox pull-left"><input type="checkbox" name="save-login"> {-"Remember Me"|translate}</label>
                                <a href="{-"index.php?m=register&action=forgetPw"|URL}" class="pull-right" style="padding-top:7px">{-"I forgot my password"|translate}</a>
                            </div>
                            <div class="form-group">
